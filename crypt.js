...
function VesualBot(bots,loc)
{
	...
	{
		cord+=40;
		k+= "<img src='img/podzemka/bots/"+bots[i]+".gif' style='POSITION:absolute;LEFT:"+cord+"px;' alt='Подземные существа'>";
	}
...
function VesualBot2(bots,loc)
{
	...
	{
		cord+=35;
		k+= "<img src='img/podzemka/bots/"+bots[i]+".gif' style='WIDTH:80px;POSITION:absolute;LEFT:"+cord+"px;' alt='Подземные существа'>";
	}
	//k="<div style='CURSOR:hand' onClick=\"OpenMenu('"+loc+"');\">"+k+"</div>";
