...
function dialog()
{
	bernard.innerHTML='<B>Ведунья:</B><BR>'+
	'Здравствуй, внучек! С чем пожаловал?!!!<BR>'+
...
<tr>
	...
	<td width=210 valign=top>
		<?
		$result=mysql_query("SELECT * FROM users WHERE login='Ведунья' limit 1");
