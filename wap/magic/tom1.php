...
else
{
	...
	if ($proff["Лесоруб"]<50)$_SESSION["message"]="Требуется Рейтинг Лесоруба 50. Не хватает ".(50-$proff["Лесоруб"])."!";
	else if ($proff["Рыбак"]<50)$_SESSION["message"]="Требуется Рейтинг Рыбака 50. Не хватает ".(50-$proff["Рыбак"])."!";
	else
	{
