...
if($db["battle"] && $db["hp"] && $db["battle_opponent"]!="")
{
	...
	for($i=0;$i<$n;$i++) 
	{
		...
		{
			$uron=$uron/2;
			$phrase.= "<span class=date>$date</span> <span class=$span2>$opponenti</span> пон€л что его спасение это прием <b>ѕризрачный ¬оздух</b>.<br>";
		...
		{
			$uron=$uron/2;
			$phrase.= "<span class=date>$date</span> <span class=$span2>$opponenti</span> пон€л что его спасение это прием <b>јктивна€ защита</b>.<br>";
		...
		{
			$uron=1;
			$phrase.= "<span class=date>$date</span> <span class=$span2>$opponenti</span> пон€л что его спасение это прием <b>ѕолна€ защита</b>.<br>";
