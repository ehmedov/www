<?
	function calc_mag($pers,$magic_type)
	{
		...
		if ($pers["hand_r_type"]=="staff")$k=rand($pers["hand_r_hitmin"]+$is_modified+$effect["min_udar"],$pers["hand_r_hitmax"]+$is_modified+$effect["max_udar"])*(1+0.07*($pers["staff_vl"]+$add_magic));
