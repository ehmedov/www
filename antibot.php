...
class genrandomimage 
{
	...
	var $jpeg_quality = 100; // максимальное, можно поставить 70-80
	
	var $keystring = ''; // ключевая генерируемая строка

	// символы, используемые для рисования сгенерированного изображения CAPTCHA	
	var $allowed_symbols = "23456789abcdeghkmnpqrsuvxyz"; // алфавит БЕЗ похожих символов (o=0, 1=l, i=j, t=f)
	
	// количество символов в строке
	var $length_min = 4; // минимальное
