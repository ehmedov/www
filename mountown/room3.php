...
<tr>
	...
	<td align="right" valign="top" width=100%>
		<DIV style="position:relative; width:350px; height:288px;" >
		    ...
		    <div style="position: absolute; left:220;top:0px; 	z-index: 1;" ><img src="img/city/m.gif" border="0"/></div>
		...
		<small>Опытные командиры и великолепные воины, <br>покрытые шрамами тысяч сражений - им отведен отдельный Зал. <br>(уровни 10 и выше)</small>
		<hr>	
