	...
	<table width="100%" cellspacing="1" cellpadding="3" class="l3">
        <tr class="l0">
            <td>
				...
				<INPUT TYPE=button style="width:100%;font-weight:bold;" onclick="location.href='main.php?act=go&level=artshop'" value="Артефактный магазин" class="newbut">
				<INPUT TYPE=button style="width:100%;" class="podskazka" value="Подсказка" onclick="window.open('help/art.php','displayWindow','height=400,width=500,resizable=no,scrollbars=yes,menubar=no,status=no,toolbar=no,directories=no,location=no')"/>
            </td>
        </tr>
	</table>
	<br>
