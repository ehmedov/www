...
<tr>
	...
	<td align="right" valign="top" width=100%>
		<DIV style="position:relative; width:350px; height:288px;" >
		    ...
		    <div style="position: absolute; left:40px;top:140px; 	z-index: 1;" ><img src="img/city/m.gif" border="0"/></div>
			...
			<div style="position: absolute; left:267px;top:140px; 	z-index: 1;" align=center class="nav" onclick="document.location.href='main.php?act=go&level=room5'" 	onmouseout="stopfilter(this)" onmouseover="startfilter(this)" title="Те, кто повидал много кровавых сеч и сражений, могут уединиться от шумной толпы новичков и воинов. (уровни 20 и выше)">Зал<br>Славы</div>
		</div>
		<small>Шумно и людно в комнате начинающих, <br>здесь пробуют свои силы неокрепшие юнцы <br>желающие поднатореть в воинском искусстве.</small>
		<hr>
