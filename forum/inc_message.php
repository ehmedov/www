...
<form method="POST" name='add_top' action='?action=add&fid=<?=$fid;?>&tid=<?=$tid;?>'>	
...
<td colspan=2 style="background-image:url('design/bg.gif')">
	...
	<img src="design/brkspace.gif" width="5" height="25" border="0">
	<img title="Смайлики" style="cursor:hand" src="design/emo.gif" width="23" height="25" border="0" onclick="ins_smile();">
	<img src="design/brkspace.gif" width="5" height="25" border="0">
	<?if ($USER_DATA["adminsite"]){?>
	<img title="Вставить изображение" style="cursor:hand" src="design/img.gif" width="23" height="25" border="0" onclick="paste(' [img]','[/img]');">
	<img src="design/brkspace.gif" width="5" height="25" border="0">
	<?}?>	
