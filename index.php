...
<html>
<head>
	<title>XAKUS- Отличная RPG онлайн игра посвященная боям и магии</title>
...
?>
	<p id="logo" style="height:175px;">
	</p>

<div id="container">
<div class="arkdiv">
<img class="ark" src="img/ark.png" >
</div>
	...
	<div align='center'>
		...
		<a href="forum/forum.php"  onclick="window.open(this.href);return false;">Форум</a>
	</div>
	<div align='center'>
		<? 
	...
	<div id="footer" align='center'>
		<p class="center">© Copyright 2006-<?=date("Y")?> XAKUS - бесплатная онлайн игра</p>
		<?include("counter.php");?>
	</div>
</div>
</body>
