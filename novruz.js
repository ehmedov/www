...
function VesualBot(bots,loc)
{
	...
	{
		cord+=40;
		k+= "<img src='img/novruz/bots/"+bots[i]+".gif' style='POSITION:absolute;LEFT:"+cord+"px;' alt='Подземные существа'>";
	}
...
function VesualBot2(bots,loc)
{
	...
	{
		cord+=35;
		k+= "<img src='img/novruz/bots/"+bots[i]+".gif' style='height:100px;POSITION:absolute;LEFT:"+cord+"px;' alt='Подземные существа'>";
	}
	//k="<div style='CURSOR:hand' onClick=\"OpenMenu('"+loc+"');\">"+k+"</div>";
