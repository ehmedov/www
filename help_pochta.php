...
function dialog()
{
	bernard.innerHTML='<B>Путешественник:</B><BR>'+
	'Доброго времени суток, гражданин!<br>'+
	'Какая сегодня чудесная погода, не правда ли? <br>'+
...
<tr>
	...
	<td width=210 valign=top>
		<?
		$result=mysql_query("SELECT * FROM users WHERE login='Путешественник' limit 1");
